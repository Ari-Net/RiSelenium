...
namespace Arisha_Selenium
{
    class Scenario4
    {
        ...
        public void test()
        {
            ...
            Assert.AreEqual(currentURL, "https://www.epam.com/search?q=adjah");

            IWebElement results = driver.FindElement(By.XPath("/html/body/div[2]/main/div[1]/div/section/div/div[2]/section/div[1]"));
            bool see = results.Displayed;
        }
        [TearDown]
